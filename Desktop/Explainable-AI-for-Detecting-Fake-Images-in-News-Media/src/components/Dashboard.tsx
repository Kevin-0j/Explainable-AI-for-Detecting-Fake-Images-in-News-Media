            ...
            <Card className="border border-[#dedede] shadow-sm bg-[#FAFAFA]">
              ...
              <CardContent>
                <div className="text-center py-8">
                  <div className="w-16 h-16 bg-[#F2F2F2] rounded-lg flex items-center justify-center mx-auto mb-4">
                    <Upload className="h-8 w-8 text-[#1F1F1F]" />
                  </div>
                ...
                <div className="space-y-4">
                  {recentResults.length === 0 ? (
                    ...
                    recentResults.map((result) => (
                      <div key={result.id} className="flex items-center justify-between p-3 bg-[#F5F5F5] rounded-lg">
