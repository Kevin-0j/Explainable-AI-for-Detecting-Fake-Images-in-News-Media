      ...
      <main className="flex-1 overflow-auto">
        <div className="p-8">
              ...
              <CardContent className="space-y-6">
                <div className="space-y-2">
                  ...
                  <Select defaultValue="v2.1">
                    ...
                    <SelectContent>
                      <SelectItem value="v2.1">Newsight v2.1 (Current)</SelectItem>
                      <SelectItem value="v2.0">Newsight v2.0 (Legacy)</SelectItem>
                      <SelectItem value="v1.9">Newsight v1.9 (Legacy)</SelectItem>
                    </SelectContent>
                  </Select>
                </div>
          ...
          <div className="mt-8 flex flex-col sm:flex-row gap-4">
            <Button onClick={handleSaveSettings} className="bg-[#1F1F1F] text-white hover:bg-[#1F1F1F]/90">
              <CheckCircle className="h-4 w-4 mr-2" />
              Save All Settings
            </Button>
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="text-sm">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-blue-700">
                    <div>Version: Newsight v2.1.0</div>
