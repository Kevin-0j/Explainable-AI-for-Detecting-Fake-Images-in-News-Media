  ...
  return (
    <div className="min-h-screen bg-[#E5E5E5] flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <Card className="shadow-lg border border-[#dedede] bg-[#FAFAFA]">
          <CardHeader className="text-center">
            <div className="flex items-center justify-center gap-2 mb-2">
              <Shield className="h-8 w-8 text-[#1F1F1F]" />
          ...
          <CardContent>
            ...
            <form onSubmit={handleLogin} className="space-y-4">
              ...
              <Button type="submit" className="w-full bg-[#1F1F1F] text-white hover:bg-[#1F1F1F]/90">
